...
-- ── 4. team_members → profiles foreign key ───────────────────────────
...
--   match_result_votes  kaptan skor anlaşması
--   ratings             oyuncu maç reytingleri
--   team_members        → profiles FK eklendi
--
-- Triggerlar:
